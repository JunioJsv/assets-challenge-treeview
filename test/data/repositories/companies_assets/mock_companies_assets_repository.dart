...
class MockCompaniesAssetsRepository implements ICompaniesAssetsRepository {
  @override
  Future<List<domain.Company>> getCompanies() {
    return Future.value(
      [
        data.Company(id: '1', name: 'Company A'),
        data.Company(id: '2', name: 'Company B'),
        data.Company(id: '3', name: 'Company C'),
